...
describe('Authors Controller', () => {
  ...
  describe('createAuthor', () => {
    it('should create an author and return 200', async () => {
      const authorData = { firstName: 'John', lastName: 'Doe', email: 'john@example.com', dateOfBirth: new Date() };
  ...
  describe('getAuthorById', () => {
    it('should return author with 200 when found', async () => {
      ...
      await AuthorsController.getAuthorById(mockReq as Request<{ id: string }>, mockRes as Response, mockNext);
  ...
  describe('updateAuthor', () => {
    it('should update author and return 200', async () => {
      ...
      await AuthorsController.updateAuthor(mockReq as Request<{ id: string }>, mockRes as Response, mockNext);
  ...
  describe('deleteAuthor', () => {
    it('should delete author and return 200 with message', async () => {
      ...
      await AuthorsController.deleteAuthor(mockReq as Request<{ id: string }>, mockRes as Response, mockNext);
  ...
  describe('restoreAuthor', () => {
    it('should restore author and return 200 with message', async () => {
      ...
      await AuthorsController.restoreAuthor(mockReq as Request<{ id: string }>, mockRes as Response, mockNext);
