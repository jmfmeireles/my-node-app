...
describe('Movies Controller', () => {
  ...
  describe('getMovieById', () => {
    it('should return movie with 200 when found', async () => {
      ...
      await MoviesController.getMovieById(mockReq as Request<{ id: string }>, mockRes as Response, mockNext);
  ...
  describe('updateMovie', () => {
    it('should update movie and return 200', async () => {
      ...
      await MoviesController.updateMovie(mockReq as Request<{ id: string }>, mockRes as Response, mockNext);
  ...
  describe('deleteMovie', () => {
    it('should delete movie and return 200 with message', async () => {
      ...
      await MoviesController.deleteMovie(mockReq as Request<{ id: string }>, mockRes as Response, mockNext);
