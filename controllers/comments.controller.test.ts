...
describe('Comments Controller', () => {
  ...
  describe('getPaginatedComments', () => {
    it('should return paginated comments with default page and limit', async () => {
      ...
      await CommentsController.getPaginatedComments(mockReq as Request, mockRes as Response, mockNext);
  ...
  describe('getCommentById', () => {
    it('should return comment with 200 when found', async () => {
      ...
      await CommentsController.getCommentById(mockReq as Request<{ id: string }>, mockRes as Response, mockNext);
  ...
  describe('updateComment', () => {
    it('should update comment and return 200', async () => {
      ...
      await CommentsController.updateComment(mockReq as Request<{ id: string }>, mockRes as Response, mockNext);
  ...
  describe('deleteComment', () => {
    it('should delete comment and return 200 with message', async () => {
      ...
      await CommentsController.deleteComment(mockReq as Request<{ id: string }>, mockRes as Response, mockNext);
