...
describe("Books Controller", () => {
  ...
  describe("getBookById", () => {
    it("should return book with 200 when found", async () => {
      ...
      await BooksController.getBookById(
  ...
  describe("removeBookFromShelf", () => {
    it("should remove book from shelf and return 200", async () => {
      ...
      await BooksController.removeBookFromShelf(
        mockReq as Request<{ bookId: string; shelfId: string }>,
        mockRes as Response,
        mockNext
      );
  ...
  describe("getBookShelves", () => {
    it("should return book shelves with 200", async () => {
      ...
      await BooksController.getBookShelves(
        mockReq as Request<{ id: string }>,
        mockRes as Response,
        mockNext
      );
