...
describe('Comments Service', () => {
  ...
  describe('createComment', () => {
    ...
    it('should throw an error if insert fails', async () => {
      ...
      await expect(CommentsService.createComment(newComment)).rejects.toThrow('Failed to create comment');
    });
  });
  ...
  describe('updateComment', () => {
    it('should return null if comment not found', async () => {
      ...
      const result = await CommentsService.updateComment('507f1f77bcf86cd799439011', { text: 'Updated' });
    ...
    it('should update comment successfully', async () => {
      ...
      const result = await CommentsService.updateComment(commentId.toString(), { text: 'Updated Comment' });
  ...
  describe('deleteComment', () => {
    it('should throw an error if comment not found', async () => {
      ...
      await expect(CommentsService.deleteComment('507f1f77bcf86cd799439011')).rejects.toThrow('Comment not found');
    });
